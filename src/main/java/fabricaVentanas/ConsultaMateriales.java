...
public class ConsultaMateriales extends javax.swing.JFrame implements IConsulta {
    ...
    /**
     * Creates new form ConsultaMateriales
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaMateriales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaMateriales().setVisible(true);
            }
        });
    }
    ...
    public void iniciar() {
        ...
        System.out.println("Ha iniciado la pantalla Consulta Materiales");
    }
